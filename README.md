...
[![Version](https://img.shields.io/badge/version-1.1.4-blue.svg)](https://github.com/ThanhMiLa/SpringLens/releases)
...
1. Download `SpringLens-1.1.4.zip` from [GitHub Releases](https://github.com/ThanhMiLa/SpringLens/releases).
...
./gradlew buildPlugin
```
The packaged plugin will be available at `build/distributions/SpringLens-1.1.4.zip`.
